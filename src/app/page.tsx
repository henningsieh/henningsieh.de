...
export default function RootLayout() {
  ...
  if (!mounted) {
    return null; // Return null until the component is hydrated
  }
                ...
                <Card>
                  ...
                  <CardContent>
                    <p className="text-muted-foreground">
                      ...
                      moderner Webtechnologien und der Entwicklung skalierbarer, effizienter
                      Lösungen. Mit meinem Hintergrund in Requirements Engineering und
                      Softwarearchitektur kann ich komplexe Projekte von der Konzeption bis
                      zur Umsetzung erfolgreich begleiten und dabei stets die Balance
                      zwischen technischer Exzellenz und geschäftlichen Anforderungen
                      wahren.
                    </p>
                  </CardContent>
                </Card>
